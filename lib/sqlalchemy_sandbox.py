...
if __name__ == '__main__':
    ...
    # create session, student objects, using desc()
    ...
    # If you don't have a single object ready for deletion but 
    # you know the criteria for deletion, you can call the delete() method 
